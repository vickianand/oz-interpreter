...
declare
fun {MatchRecords Rec1 Rec2 Env}
   %{Browse inside_match_records_function} {Browse Rec1} {Browse Rec2} {Browse outside_match_records_function}
   case Rec1
   of nil then true
   else
      if Rec1.1.1 \= Rec2.1.1 then false else {MatchRecords Rec1.2 Rec2.2 Env} end
   end
end
